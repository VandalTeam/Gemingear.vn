                           ...
                           <h3>GET THE APP</h3>
                            ...
                            <div class="app_img">
                                <figure class="app_img">
                                    <a href="#"><img src="{{asset('assets/customer/img/icon/icon-appstore.')}}png" alt=""></a>
                                </figure>
                                <figure class="app_img">
                                    <a href="#"><img src="{{asset('assets/customer/img/icon/icon-googlepla')}}y.png" alt=""></a>
                                </figure>
                            </div> 
                        </div>
                    </div>
                            ...
                            <div class="footer_contact">
                               <div class="footer_contact_inner">
                                    <div class="contact_icone">
                                        <img src="{{asset('assets/customer/img/icon/icon-phone.png')}}" alt="">
                                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                       <div class="footer_payment text-right">
                            <img src="{{asset('assets/customer/img/icon/payment.png')}}">
                        </div>
                    </div>
                </div>
            </div>
