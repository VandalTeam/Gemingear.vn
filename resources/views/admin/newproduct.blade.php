...
<div class="body_scroll">
    ...
    <div class="container-fluid">
        <form action="<?php if(isset($products)){echo '/admin/product/update/'.$products->id;}else{echo '/admin/product/insert';}?>" method="POST" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        <select class="form-control ms" id="select-category" name="category_id" required>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="body">
                                            <input type="file" class="dropify" name="img[]" data-height="500px" 
                                            multiple data-default-file="<?php if(isset($products)){ if(strpos($products->image,'uploads')==false){ echo $products->image;} else{echo 'http://gemingear.vn/storage/'.explode('&', $products->image)[0];}}?>" 
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control ms" id="select-promotion" name="promotion_id" required>
                                        <option selected disabled>--> Chọn khuyến mãi <--</option>
                                                ...
                                                selected
                                                @endif
                                                value="<?= $item->id?>"><?= $item->name." ".$item->sale_present."%"?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
